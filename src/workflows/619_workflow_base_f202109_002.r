...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_custom.r"
...
wf_septiembre <- function( pnombrewf, metodo_df )
{
  ...
  FEintra_manual_base()
  DR_drifting_base(metodo=metodo_dr)
  FEhist_base()
...
for (metodo_param in c("ninguno" ,"rank_simple" , "deflacion", "estandarizar" )) {
