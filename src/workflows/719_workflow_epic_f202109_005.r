...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202104, 202105, 202012, 202011,
    201912, 201911, 201908, 201907, 201904, 201903)
...
wf_septiembre <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( c(ht, ts9), ranks=c(1), semillerio=35, repeticiones_exp=1 )
