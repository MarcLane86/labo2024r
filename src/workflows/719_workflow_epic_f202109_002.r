...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1401_DR_corregir_drifting_002.r"
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1501_FE_historia_001.r"

  param_local$lag1 <- FALSE #MODIFICADO
  param_local$lag2 <- TRUE #MODIFICADO
  param_local$lag3 <- TRUE #MODIFICADO
  ...
  param_local$Tendencias1$ratiomax <- TRUE #MODIFICADO
  param_local$Tendencias1$ema <- TRUE #AGREGADO
  param_local$Tendencias1$bbwp <- TRUE #AGREGADO
  param_local$Tendencias1$bbwp_ventana <-  7 #AGREGADO
  
  
  # no me engraso las manos con las tendencias de segundo orden
  param_local$delta_lags2_ema <- TRUE #AGREGADO
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202102,
    202101, 202012, 202004, 202003, 202002, 201911, 201910, 201909, 201906, 201905, 201904)


  param_local$train$training <- c(202104, 202103, 202102, 202011, 202010,
    202009, 202001, 201912, 201911, 201908, 20197, 201906, 201903, 201902, 201901)
